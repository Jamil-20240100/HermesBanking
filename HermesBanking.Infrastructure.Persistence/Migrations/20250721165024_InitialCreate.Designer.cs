...
namespace HermesBanking.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250721165024_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HermesBanking.Core.Domain.Entities.Transaction", b =>
                {
                    b.HasOne("HermesBanking.Core.Domain.Entities.Beneficiary", null)
                        .WithMany()
                        .HasForeignKey("BeneficiaryId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("HermesBanking.Core.Domain.Entities.CreditCard", "CreditCard")
                        .WithMany()
                        .HasForeignKey("CreditCardId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("HermesBanking.Core.Domain.Entities.Loan", null)
                        .WithMany()
                        .HasForeignKey("LoanId")
                        .OnDelete(DeleteBehavior.SetNull);
